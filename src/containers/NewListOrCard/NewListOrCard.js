...
class NewListOrCard extends Component {
  ...
  render() {
    ...
    let descForm = this.props.itemType === "Card" ? (<Form.Item>
    ...
    return (
      <div>
        <Button type="primary" size="large" icon="plus-circle" onClick={this.showModal}>
        ...
        >
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <Form.Item>
              <Row gutter={[0, 3]}>
                <Col span={16}></Col>
                <Col span={4} style={{ marginRight: "5" }}><Button type="primary" onClick={() => this.setState({ visible: false })}>
                  Cancel
          </Button>
                </Col>
                <Col span={4} >
...
export default connect(mapStateToProps, mapDispatchToProps)(WrappedNewListOrCard);